    ...
    for (var i = 0; i < args.length; i++) {
      ...
      try {
        if (((('-name'.compareTo(args[i]) == 0) &&
                    ('-type'.compareTo(args[i + 1]) != 0)) &&
                ('-price'.compareTo(args[i + 1]) != 0)) &&
            ('-quantity'.compareTo(args[i + 1]) != 0)) {
      ...
      try {
        if (((('-price'.compareTo(args[i]) == 0) &&
                    ('-type'.compareTo(args[i + 1]) != 0)) &&
                ('quantity'.compareTo(args[i + 1]) != 0)) &&
            ('-name'.compareTo(args[i + 1]) != 0)) {
          try {
      ...
      try {
        if (((('-quantity'.compareTo(args[i]) == 0) &&
                    ('-type'.compareTo(args[i + 1]) != 0)) &&
                ('-price'.compareTo(args[i + 1]) != 0)) &&
            ('-name'.compareTo(args[i + 1]) != 0)) {
          try {
